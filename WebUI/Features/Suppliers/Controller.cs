...
using Application.Suppliers.Shared.Models;
using Mediator;
using Microsoft.AspNetCore.Mvc;
using Northwind.Application.Suppliers.Queries;
using Northwind.Application.Suppliers.Commands;
using Index = Application.Suppliers.Queries.Index;

public class SuppliersController(ISender mediator) : Controller
{
