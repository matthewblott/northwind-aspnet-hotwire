namespace Northwind.WebUI.Features.Orders;

using Application.Orders.Shared.Models;
using Mediator;
using Microsoft.AspNetCore.Mvc;
using Northwind.Application.Orders.Queries;
using Northwind.Application.Orders.Commands;
using Index = Application.Orders.Queries.Index;

public class OrdersController(ISender mediator) : Controller
{
