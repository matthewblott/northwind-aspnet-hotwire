namespace Northwind.WebUI.Features.Shippers;

using Application.Shippers.Shared.Models;
using Mediator;
using Microsoft.AspNetCore.Mvc;
using Northwind.Application.Shippers.Queries;
using Northwind.Application.Shippers.Commands;
using Index = Application.Shippers.Queries.Index;

public class ShippersController(ISender mediator) : Controller
{
