namespace Northwind.WebUI.Features.Addresses;

using Application.Addresses.Shared.Models;
using Mediator;
using Microsoft.AspNetCore.Mvc;
using Northwind.Application.Addresses.Queries;
using Northwind.Application.Addresses.Commands;
using Index = Application.Addresses.Queries.Index;

public class AddressesController(ISender mediator) : Controller
{
